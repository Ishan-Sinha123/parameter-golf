...
- **Commit / branch:** `b862f3cd8360…` on `autoresearch-deploy`
- **Stage:** screen, 8× H100 SXM, `world_size=8`, `grad_accum_steps=1`
- **Seed:** 444
- **Model params:** 29,317,732 (`model_params:29317732` in `train.log`)
...
| Key | Value |
| --- | --- |
| `NUM_LAYERS` | **12** (novel: +1 over the 11 L precedent) |
| `MODEL_DIM` | 512 |
...
Baseline used for Δ calc: **1.0810** (our current best baseline per task
prompt). Author-claim reference: **1.10597 bpb (σ = 0.00032, n=3)**.
